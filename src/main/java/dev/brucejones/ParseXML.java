package dev.brucejones;// Modified Code based on example file for parsing XML file
//by David (Duy) Nghiem
...
public class ParseXML{
        ...
        throws ParserConfigurationException{
            this.d = getDocFromFile("src/main/resources/dev/brucejones/board.xml");
            this.c = getDocFromFile("src/main/resources/dev/brucejones/cards.xml");
        }
